...
export const CardPlaylist = ({ playlists, isPlayable}: PlaylistRecommendationProps) => {
  ...
  return (
    ...
    >
      <div className={`${styles.divPlay} relative`}>
        ...
        />
        <MdPlayCircleFilled onClick={handlePlay} className={`absolute text-5xl rounded-lg z-50 bottom-3 right-0 text-[#ffff66] ${!showPlay ? 'opacity-0' : 'opacity-100 bottom-3 right-3'} transition-all duration-200`}/>
      </div>
